...
from dataset.zoom_siglip import  ZoomLatentOneClassDataset
...
SIGLIP_CACHE_DIR = Path("/home/ubuntu/AMIT/data/dataset_zoom_30mb_notfiltered_10_siglip")
...
MAX_STEPS = 100_000  # total training steps (global_step)
VAL_INTERVAL_STEPS = 1000  # run validation every N train steps

IMAGE_LOG_EVERY_STEPS = 250
SAMPLES_DIR = Path("samples_real_training")
OUTPUT_DIR = Path("runs_sana/zoom_siglip_zoom_big_run")
...
LR = 1e-4
USE_LORA = True
SIGLIP_DIM = 768  # only used if you actually provide siglip_cache_dir
NUM_WORKERS = 4
PRECISION = "bf16-mixed"  # or "16-mixed" / "fp32"

WANDB_PROJECT = "sana15_zoom_siglip"
WANDB_RUN_NAME = "zoom_siglip_zoom"
